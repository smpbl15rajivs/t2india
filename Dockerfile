...
ENV FLASK_APP=your_app_file.py  # IMPORTANT: Replace 'your_app_file.py' with your actual Flask application file
...
CMD ["gunicorn", "--workers", "4", "--bind", "0.0.0.0:5000", "your_app_file:app"] # IMPORTANT: Replace 'your_app_file:app'
