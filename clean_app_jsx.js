...
// Read the original working App.jsx from backup or recreate it
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100">
      ...
      <header className="bg-white/80 backdrop-blur-sm shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            <div className="text-xl font-bold text-purple-600">T2India</div>
      ...
      <div className="relative">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <div className="mb-6">
            <img 
              src="https://www.t2india.com/images/logo.png" 
              alt="T2India Logo" 
          ...
          <h1 className="text-2xl md:text-3xl font-light text-gray-700 mb-8">
            Discover Incredible India with Local Artisans & Authentic Experiences
          </h1>

          {/* Enhanced Search Box - Made Larger */}
          <div className="relative max-w-4xl mx-auto mb-8">
            <div className="relative">
              <input
                ...
                className="w-full px-8 py-6 text-lg border-2 border-purple-300 rounded-full shadow-lg focus:outline-none focus:border-purple-500 focus:shadow-xl transition-all duration-300 bg-white/90 backdrop-blur-sm"
              />
...
fs.writeFileSync('/home/ubuntu/t2india-google-homepage/src/App.jsx', cleanContent);

console.log('Created clean App.jsx file with larger search box');`;

// Write the script
fs.writeFileSync('/home/ubuntu/clean_app_jsx.js', cleanContent);
